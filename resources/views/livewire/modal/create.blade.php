<div class="fixed z-10 inset-0 overflow-y-auto ease-out duration-400 ">
    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0 ">
      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full " role="dialog" aria-modal="true" aria-labelledby="modal-headline">
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4  dark:text-white dark:bg-gray-600">
  
          <div class="">
  
                <div class="mb-4">
  
                    <label for="exampleFormControlInput1" class="block text-gray-700 text-sm font-bold mb-2 text-white">Title:</label>
                ...
                <div class="mb-4">
                    ...
                    <label for="exampleFormControlInput2" class="block text-gray-700 text-sm font-bold mb-2 text-white">Body:</label>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse  dark:text-white dark:bg-gray-600">
